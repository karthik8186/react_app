...
function Cart() {
  ...
  const deletcart = (id) => {
    fetch("https://commerce-appp.onrender.com/cart-data/" + id, {
      method: "DELETE"
    })
      .then(() => {
        alert("deleted")
  ...
  return (
    <div>
      ...
      <p className="h4" style={{ marginLeft:"67%",width:"300px",padding:"5px"}}> Total Cart Price:<i className="fa-solid fa-indian-rupee-sign" style={{color: "#000000;"}}></i>{total}</p>
    </div>
