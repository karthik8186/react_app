...
function Free() {
  ...
  const senddata = (id) => {
    fetch("https://commerce-appp.onrender.com/e-commerce/" + id)
      .then((res) => {
        let x = res.json()
        console.log(x)
        return x
      ...
      .then((resp) => {
        console.log(resp)
        fetch("https://commerce-appp.onrender.com/cart-data", {
          method: "POST",
  ...
  useEffect(() => {
    fetch("https://commerce-appp.onrender.com/e-commerce")
      .then((res) => {
        return res.json()
      })
      .then((resp) => {
  ...
  const search = async (kk) => {
    kk.preventDefault()
    return await axios.get(`https://commerce-appp.onrender.com/e-commerce?q=${value}`)
      .then((g) => {
        setData(g.data)
      })
      .catch((err) => {
  ...
  const sorting = async (s) => {
    ...
    setSort(value)
    return await axios.get(`https://commerce-appp.onrender.com/e-commerce?_sort=${value}&_order=asc`)
      .then((res) => {
        setData(res.data)
      })
      .catch(() => {
